<template>
  ...
  <div v-else
    ...
    <!-- Top-right: Reward + Check if joined -->
    <div v-if="joined" class="absolute top-2 right-2 flex items-center space-x-2">
      <div
    ...
    <div class="relative z-10">
      ...
      <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4 gap-2">
        ...
        <!-- Reward + Expired -->
        <div class="flex flex-col sm:flex-row sm:items-center sm:gap-3 gap-2" v-if="!joined && dueDate">
          <div
            ...
            <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1.5" viewBox="0 0 20 20"
              fill="currentColor">
              <path
                d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 010 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" />
            </svg>
      ...
      <!-- Not Joined + Buy Ticket -->
      <div v-if="!joined" class="mt-5 flex flex-col items-end space-y-2">
        <div class="text-gray-500 text-sm bg-gray-50/80 px-3 py-1.5 rounded-full border border-gray-100 shadow-sm">
          Not Joined
        </div>
        <button
